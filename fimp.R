...
fewcoordinates_token <- rtweet::rtweet_bot(
...
lon <- round(runif(1, 93.342, 151.3811), 4)
lon <- format(lon, scientific = FALSE)
lat <- round(runif(1, -14.7967, 23.0782), 4)
...
latlon_details <- paste0(
  "ℹ️: ", "Filipinas, Indonesia, Malasia, Papúa Nueva Guinea/Philippines, Indonesia, Malaysia, Papua New Guinea (FIMP)", "\n",
  "📍: ", lat, ", ", lon, "\n",
...
alt_text <- paste(
  "A satellite image of a random location in the world,",
